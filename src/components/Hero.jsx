  ...
  return (
    <section className="bg-primary text-white relative">
      <div className="container grid grid-cols-1 md:grid-cols-3 min-h-[700px] md:gap-32">
        ...
        {/* Hero Image Section */}
        <div className="flex flex-col justify-center items-center relative gap-16 mb-10">
          <motion.img
          ...
          >
            <button className="h-8 w-8 bg-red-500 flex justify-center items-center p-3  rounded-full  duration-200">
              <FaPlay />
            </button>
        ...
        <div className="flex flex-col justify-end items-center lg:px-8 py-16">
          ...
          >
            ...
            veritatis quisquam delectus, recusandae fuga consequuntur minusi.
          </motion.p>
          <motion.div
